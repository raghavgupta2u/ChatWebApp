...
if(isset($_POST["register"]))
{
    ...
    else
    {
        if($user_object->save_data())
        {
            ...
            $mail->Username   = '';  //Enter your Gmail                   // SMTP username
            ...
            $mail->setFrom('ChatApp@Verification.info', 'Raghav');
            ...
            <p>Thank you for registering for Chat Application Demo.</p>
                ...
                <p><a href="http://localhost:80/ratchet/verify.php?code='.$user_object->getUserVerificationCode().'">Click to Verify</a></p>
                <p>Thank you...</p>
            ';
